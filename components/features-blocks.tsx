            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        ...
                        <p className="text-xl text-gray-600">We are always pushing ourselves to create better experience for our stackholders & users</p>
                    </div>
                    ...
                    <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
                        ...
                        <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                            ...
                            <p className="text-gray-600 text-center">
                                Make shoppings easier for everyone! You don't need to know how to shop. We got it!
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                            ...
                            <p className="text-gray-600 text-center">
                                Provide support for people who are uncertain about a purchase decision. We can advice
                                you!
                            </p>
                        </div>
                    </div>
